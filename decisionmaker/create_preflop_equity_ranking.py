...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('Preflop_ranking')
        ...
        for i in range(len(hands)):
            ...
            for j in range(i,len(hands)):
                ...
                if not (suit1==suits[0] and card1==card2):
                    ...
                    Simulation.run_montecarlo(logger, my_cards, cards_on_table, players, ui=None, maxRuns=15000, timeout=start_time, ghost_cards='', opponent_range=1)
