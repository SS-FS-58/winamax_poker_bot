...
class History:
    def __init__(self, table_name):
        ...
        self.uploader = {}
        self.game_table_name = table_name # add by zq 20203/24
        self.round_number = 0
        self.previous_round_pot_value = 0.0
        self.fastfold = False
        # self.bot_preflop_position_utg = 0
...
class CurrentHandPreflopState:
    ...
    def get_reverse_sheetname(self, abs_pos, t, h):
        ...
        if self.bot_preflop_decision == 'Bet' \
                or self.bot_preflop_decision == 'Bet 1/2 POT' \
