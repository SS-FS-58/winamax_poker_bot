...
class StrategyHandler(object):
    ...
    def read_strategy(self, strategy_override=''):
        ...
        try:
            ...
            cursor = self.mongodb.strategies.find({'Strategy': "Default1"})
            self.selected_strategy = cursor.next()
        self.check_defaults()
...
class GameLogger(object):
    ...
    def get_stacked_bar_data(self, p_name, p_value, chartType):
        ...
        self.decisions = ['Bet Bluff', 'Check Deception', 'Call Deception', 'Fold', 'Check', 'Call', 'Bet', 'Bet 1/2 POT',
        ...
        if chartType == 'stackedBar':
            FinalData = [[self.d['Bet Bluff', 'PreFlop', 'Won'], self.d['Bet Bluff', 'PreFlop', 'Lost'], 0,
                         ...
                         [self.d['Bet', 'PreFlop', 'Won'] + self.d['Bet 1/2 POT', 'PreFlop', 'Won'],
                          self.d['Bet', 'PreFlop', 'Lost'] + self.d['Bet 1/2 POT', 'PreFlop', 'Lost'], 0,
                          self.d['Bet', 'Flop', 'Won'] + self.d['Bet 1/2 POT', 'Flop', 'Won'],
                          self.d['Bet', 'Flop', 'Lost'] + self.d['Bet 1/2 POT', 'Flop', 'Lost'], 0,
                          self.d['Bet', 'Turn', 'Won'] + self.d['Bet 1/2 POT', 'Turn', 'Won'],
                          self.d['Bet', 'Turn', 'Lost'] + self.d['Bet 1/2 POT', 'Turn', 'Lost'], 0,
                          self.d['Bet', 'River', 'Won'] + self.d['Bet 1/2 POT', 'River', 'Won'],
                          self.d['Bet', 'River', 'Lost'] + self.d['Bet 1/2 POT', 'River', 'Lost']],
